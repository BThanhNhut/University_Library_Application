 ...
 * Use the {@link DetMayFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DetMayFragment extends Fragment {
    String tendg;
    Integer madg;

    public DetMayFragment(String tendg, Integer madg) {
        this.tendg = tendg;
        this.madg = madg;
    }
     ...
     * @return A new instance of fragment DetMayFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static DetMayFragment newInstance(String param1, String param2) {
        DetMayFragment fragment = new DetMayFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_det_may, container, false);
    }
