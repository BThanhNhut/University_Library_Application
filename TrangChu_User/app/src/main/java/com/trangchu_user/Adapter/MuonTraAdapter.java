...
public class MuonTraAdapter extends RecyclerView.Adapter<MuonTraAdapter.MuonViewHolder> {
    private final List<MuonTra> dsMuon;
    String mamuonsach = "";
    private final Context context;
    public MuonTraAdapter(List<MuonTra> dsMuon, Context context)
    {
        this.dsMuon = dsMuon;
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_item_rec_lich_su, null);
